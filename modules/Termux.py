...
os.system('clear')
print(rojo+"Tool by Hilyzx"+cierre)
os.system('sleep 5')
os.system('clear')
...
def menu():
    while True:
     ...
     print(azul+"1) Spam-SMS (Termux)                     Hilyzx                             "+cierre)                    
     ...
     if d == "3":
        ...
        print(rojo+"Cuando se abran las paginas tendras poner el numero de la victima en las casillas que te ponga solicitar el numero y aceptar o continuar de esa manera se enviara 1 sms por cada pagina"+cierre)
        time.sleep(15)
